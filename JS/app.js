...
class Item {
  ...
  const comida = new Item("Comida", 260, "comida.png");
  const dulces = new Item("Dulces", 120, "dulces.png");
  ...
  function comprar(item) {
    if (oro - item.precio <= 0) {
      ...
      alert("No ténes suficiente espacio en el inventario.");
    } else {
      // Si me alcanza, agrego el item a la mochila
      mochila.push(item);
